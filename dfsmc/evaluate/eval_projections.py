"""
Evaluate projection_datas generated from different methods

Framework:
- Choose a scope (season(s)) and set of projection_data methods to compare
- Generate projection_datas for all weeks/players in scope using all methods
...
def get_projection_residuals(projector: projection_data.ResampleProjector):
    projections = projector.get_projections().reset_index()
...
if __name__ == "__main__":
    ...
    for week in range(15,16):
        projector = projection_data.ResampleProjector(2022, week)
